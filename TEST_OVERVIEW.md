...
This folder currently has 10 automated frontend test suites with 42 total checks.  
...
- `src/utils/exploreTabSync.test.js` (5 checks): Verifies explore-page tab/URL synchronization only redirects when needed and uses safe fallback tabs.
