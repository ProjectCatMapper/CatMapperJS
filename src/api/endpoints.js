...
export const apiEndpoints = {
  ...
  polygonGeoJsonPreflight: () => '/uploads/geojson/polygons/preflight',
  polygonGeoJsonApply: (token) => `/uploads/geojson/polygons/${encodeURIComponent(token)}/apply`,
  polygonGeoJsonDiscard: (token) => `/uploads/geojson/polygons/${encodeURIComponent(token)}`,
